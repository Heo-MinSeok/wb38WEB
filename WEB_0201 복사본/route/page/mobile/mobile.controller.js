    ...
    try {
      ...
      if (req.params.stunum == user.stunum){
        if(user.stunum == 202403838) 
          res.sendFile(parentDir + "/admin/mobile_main_admin.html");
       else 
...
exports.GetEditinfo = (req, res) => {
    ...
    try {
      ...
      if (req.params.stunum == user.stunum){
        if(user.stunum == 202403838) 
            res.sendFile(parentDir + "/admin/mobile_editinfo_admin.html");
        else
...
exports.GetCheck = (req, res) => {
    ...
    try {
      ...
      if (req.params.stunum == user.stunum){
        if(user.stunum == 202403838) 
         res.sendFile(parentDir + "/admin/mobile_check_admin.html");
        else
...
exports.GetAllcheck = (req, res) => {
    ...
    try {
      ...
      if (req.params.stunum == user.stunum && user.stunum == 202403838){
        res.sendFile(parentDir + "/admin/mobile_allcheck.html");
       }
      else{
        res.sendFile(__dirname + '/autherr.html');
      }
...
exports.GetFiles = (req, res) => {
    ...
    try {
      ...
      if (req.params.stunum == user.stunum){
        if(user.stunum == 202403838) 
        res.sendFile(parentDir + "/admin/mobile_file_admin.html");
       else 
